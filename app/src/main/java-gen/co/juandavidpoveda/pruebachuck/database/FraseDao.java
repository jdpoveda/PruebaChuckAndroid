 ...
 * DAO for table frase.
*/
public class FraseDao extends AbstractDao<Frase, Long> {

    public static final String TABLENAME = "frase";

    /**
     * Properties of entity Frase.<br/>
    ...
    */
    ...
    public FraseDao(DaoConfig config) {
        super(config);
    }
    
    public FraseDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'frase'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Frase entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public Frase readEntity(Cursor cursor, int offset) {
        Frase entity = new Frase( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Frase entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Frase entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Frase entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
